  ...
  return (
    ...
    style={{ animationDelay: "0.15s", animationFillMode: "forwards" }}>
      {posts.map((post, index) => (
          ...
          // </li>
            <div key={index} className="mb-20 max-w-md container bg-white rounded-xl shadow-2xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
              <div className='pt-2'>
              ...
              <p className="ml-4 mt-1 mb-2 text-sm text-gray-700">{post.content}</p>
            </div>
      ))}
      </div>
  );
